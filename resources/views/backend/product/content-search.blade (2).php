  ...
  <div class="row">   
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-inline" id="formSearchAjax" role="form" method="GET" action="{{ route('product.ajax-search') }}">
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            @if( $items->count() > 0 )
              ...
              @foreach( $items as $item )
                ...
                ?>
              <tr id="row-{{ $item->id }}">
              <td><input type="checkbox" class="checkSelect" value="{{ $item->id }}"/></td>               
