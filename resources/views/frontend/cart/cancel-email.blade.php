                  ...
                  <tbody>
                    <tr>
                      ...
                      <h1 style="font-size:17px;font-weight:bold;color:#444;padding:0 0 5px 0;margin:0"> Chào
                        ...
                        <p style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal; font-size: 15px"> <strong style="color:#ffde00">KKAFFEE</strong> thông báo đơn hàng <strong style="color:#ffde00">#{{ $order_id }}</strong> của quý khách đã được hủy thành công.</p>
                        <br>
