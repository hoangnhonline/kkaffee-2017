        ...
        <div class="container marg40">
            <div class="row">
                ...
                <div class="col-md-6">                    
                    ...
                    @endif
                    <button type="button" data-id="{{ $detail->id }}" class="btn btn-yellow btn-lg btn-flat @if(Session::has('login')) btn-order-main @endif" @if(!Session::has('login')) data-dismiss="modal" data-toggle="modal" data-target="#login-form" @endif>MUA NGAY</button>
                    <button type="button" data-id="{{ $detail->id }}" class="btn btn-grey btn-lg btn-flat @if(Session::has('login')) btn-order @endif" @if(!Session::has('login')) data-dismiss="modal" data-toggle="modal" data-target="#login-form" @endif>THÊM VÀO GIỎ HÀNG</button>
                </div>
            </div>
        </div>
        @if($otherList)
        ...
        <div class="container">
            ...
            <div class="cart-info cart-side">
                ...
                <div class="content-cart-info">
                    <ul class="nvn-user">
                        <li class="bg_ddd">
                            <span class="pull-left cl_333"><img src="{{ Session::get('avatar') ? Session::get('avatar') :  URL::asset('public/assets/img/icon.png') }}" alt="{{ Session::get('username') }}" width="30" style="border-radius: 25px">{{ Session::get('username') }}</span>
                    ...
                    <ul class="">
                        ...
                        <li>
                            <span class="pull-left cl_666">Phí vận chuyển (Est.)</small></span>
                            <span class="pull-right cl_333">5.000đ/km</span>
                        </li>
